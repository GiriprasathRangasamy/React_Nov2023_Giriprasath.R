...
export default function Toolsgiri() {
  ...
  const settings = ['Profile', 'Account', 'Dashboard', <a href="/" style={{textDecoration:"none",color:"black"}}>Logout</a>];
    ...
    <Box sx={{ display: 'flex' }}>
      ...
      >
        ...
        <List>
          ...
          <a href='/ordernow' style={{textDecoration:"none",color:"black"}}>Stock Ordered</a>,
          <a href='/orderstatus' style={{textDecoration:"none",color:"black"}}>Order Status</a>, 
