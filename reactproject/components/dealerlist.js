...
function DealerList()
{
  const navigate=useNavigate();
    ...
    return(
        ...
        <Button style={{border:"2px solid blue",backgroundColor:"blue",color:'white'}}onClick={() => setShowAddSupplierTable(!showAddSupplierTable)}>
        ...
        <Table>
                        ...
                        <TableContainer component={Paper}>
                        <h3 style={{textAlign:"center",marginTop:"100px",color:"violet"}}><u>Supplier List</u></h3>
                         <Table>
                          <TableHead>
                            <TableRow>
